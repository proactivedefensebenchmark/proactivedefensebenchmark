"""
Batch LEAT Attack on Multiple Wrappers
...
# Import LEAT attack
from disrupting_methods.LEAT.leat import lpgd_attack
...
def parse_arguments():
    ...
    parser.add_argument(
        "--wrappers",
        nargs="+",
        # default=["simswap", "psp_mix", "diffae", "styleclip", "diffswap", "stargan", "blendface"],
        default=["diffswap"],
...
def main(args):
    ...
    if args.output_base is None:
        args.output_base = os.path.join(project_root, "batch_results_leat")
    ...
    for wrapper_name in args.wrappers:
        ...
        output_dir = os.path.join(output_root, f"result_{wrapper_name}_leat")

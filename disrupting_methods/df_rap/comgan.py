"""
Complementary Generator (ComG) for DF_RAP
Based on official DF_RAP code: https://github.com/ZOMIN28/DF_RAP
"""
import torch
...
class ComGenerator(nn.Module):
    """
    Complementary Generator (official implementation)
    """
    ...
    def forward(self, x):
        ...
        # Skip JPEG compression (isJPEG=False by default)
        return conv0_out
